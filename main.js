...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        ...
        pass: 'opavgreboldayxkx'      // Replace with your email password or an app-specific password
    }
});
...
async function randomDelay() {
    const minutes = Math.floor(Math.random() * 5) + 1; // Generate a random number between 1 and 5
